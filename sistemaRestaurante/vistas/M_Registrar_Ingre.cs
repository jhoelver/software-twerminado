...
{
    public partial class M_Registrar_Ingre : Form
    {
        public M_Registrar_Ingre()
        {
            InitializeComponent();
        }
        ...
        private void btnActualizarIngrediente_Click(object sender, EventArgs e)
        {
            ingredientes _ingre = new ingredientes();
            controlIngredientes cingredientes = new controlIngredientes();
            _ingre.Ingrediente = txtNombreActualizar.Text;
            _ingre.Stock = int.Parse(txtStockActualizar.Text);
            cingredientes.actualizarIngrediente(_ingre);
            llenarGrigIngredientes();
            txtNombreActualizar.Text = "";
            txtStockActualizar.Text = "";
        }
